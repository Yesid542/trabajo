  ...
  const navigate = useNavigate();
   useEffect(() => {
    ...
    <div className='principal'>
        <img src="../../../public/IMG/sombra.svg" alt="" className='sombra' />
        <img src="../../../public/App.svg" alt="" className='logo'/>
        <svg className='nombre' id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" width='50vw' viewBox="0 0 473.37 98.03">
...
<svg className='cargar' id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 12.92 12.92">
  
  <g id="Capa_1-2" data-name="Capa 1">
    <path class="cls-1" d="M12.92,6.46c-4.01,1.35-5.11,2.45-6.46,6.46-1.35-4.01-2.45-5.11-6.46-6.46,4.01-1.35,5.11-2.45,6.46-6.46,1.35,4.01,2.45,5.11,6.46,6.46Z"/>
  </g>
</svg>
<svg className='cargar2' id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 12.92 12.92">
  
  <g id="Capa_1-2" data-name="Capa 1">
    <path class="cls-1" d="M12.92,6.46c-4.01,1.35-5.11,2.45-6.46,6.46-1.35-4.01-2.45-5.11-6.46-6.46,4.01-1.35,5.11-2.45,6.46-6.46,1.35,4.01,2.45,5.11,6.46,6.46Z"/>
  </g>
</svg>
<svg className='cargar3' id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 12.92 12.92">
